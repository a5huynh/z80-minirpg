...
#include "playerinfo.asm" ;<- Player Data (Location, Items, etc)
#include "mover.asm"      ;<- Handles Movement
...
;#include "items.asm"     ;<- Item Routines
;#include "battle.asm"    ;<- Battle System
;#include "spellbook.asm"  ;<- Spell info
;#include "armorweapon.asm";<- Weapon and Armor info
;#include "monsters.asm"  ;<- Monster info
#include "routines.asm"   ;<- Other Routines (waitkey, etc)
